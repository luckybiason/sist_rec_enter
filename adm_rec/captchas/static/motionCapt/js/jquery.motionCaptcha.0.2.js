...
jQuery.fn.motionCaptcha || (function($) {
	...
	$.fn.motionCaptcha.defaults = {
		...
		errorMsg: 'Forma inválida. Tente novamente.',
		successMsg: 'Forma correta!',
		
		// This message is displayed if the user's browser doesn't support canvas:
		noCanvasMsg: "Navegador não suportado - atualize seu navegador e tente novamente.",
		...
		onSuccess: function($form, $canvas, ctx) {
			...
			$submit.removeAttr('disabled').slideDown();
