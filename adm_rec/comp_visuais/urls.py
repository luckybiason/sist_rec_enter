...
urlpatterns = patterns('comp_visuais',            
        ...
        ## - Cadastros Principal        
        # Componente Visual
        url(r'^comp_visuais/listagem/$',             GeneralListView.as_view(model=ComponenteVisual),   name='comp_visuais.listagem'),
        ...
        url(r'^comp_visuais/cadastro/(?P<pk>\d+)/$', GeneralUpdateView.as_view(model=ComponenteVisual, 
                                                                               template_name='comp_visuais/cadastro.html'), name='comp_visuais.cadastro'),
        #url(r'^comp_visuais/cadastro/$',             GeneralCreateView.as_view(model=ComponenteVisual), name='comp_visuais.cadastro'),
        #url(r'^comp_visuais/cadastro/(?P<pk>\d+)/$', GeneralUpdateView.as_view(model=ComponenteVisual), name='comp_visuais.cadastro'),
